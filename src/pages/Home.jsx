...
const SOCIAL_LINKS = [
    ...
    { icon: Linkedin, link: "www.linkedin.com/in/binil-b-a1a118303" },
              ...
              <span className="text-xl md:text-2xl bg-gradient-to-r from-gray-100 to-gray-300 bg-clip-text text-transparent font-light">
                {text}
                        ...
                        <p className="text-base md:text-lg text-gray-400 max-w-xl leading-relaxed font-light" data-aos="fade-up" data-aos-delay="1000">
                            Frontend Development and UI/UX Design focus on creating responsive, user-friendly interfaces. Using HTML, CSS, JavaScript, React, and Tailwind CSS, I build clean, interactive UIs with a seamless user experience, as seen in my voice diary and weather app projects.
                        </p>
